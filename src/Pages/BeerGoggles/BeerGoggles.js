            ...
            <div className="beerGooglesIntroContainer">
                <div className="projectDescription">
                    <p>
                        ...
                        and plays through the game in its entirety with another
                        HUGE member as a co-pilot. They see if they still love
            ...
            <div className="beerGogglesEpContainer">
                <figure>
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        It's time for Ben and Evan to become Rocket Scientists!
                        Join them as they dig up the past and examine Zombie
                        Dinos from Planet Zeltoid for traces of nostalgia! This
                        one is short and sweet with one episode only.
                    </figcaption>
                </figure>
                ...
                <figure>
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        Lace up your shoes and put on your Beer Goggles, it's
                        time for Evan and Tim to run through Sonic The Hedgehog
                        2! There are two parts for you to enjoy.
                    </figcaption>
                </figure>
                <figure>
                    <iframe
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        ...
                        join Matt and Ben as they sit down for a new adventure
                        with two parts!
                    </figcaption>
                </figure>
                <figure>
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        It's time for Matt and Ben to go on a magical adventure!
                        Come join them as they explore a world of
                        incomprehensible wonders! There are four whole videos in
                        this playlist for your viewing pleasure!
                    </figcaption>
                </figure>
                ...
                <figure>
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        Ohhhhhhhh boy! I sure hope you like dying. Tim and Ben
                        are going to test the time limits of Beer Goggles with
                        this game! This one's got three parts.
                    </figcaption>
                </figure>
                ...
                <figure>
                    ...
                    <figcaption className="beerGogglesFigCaption">
                        Come join Ben and Matt as they play though Pitfall: The
                        Mayan Adventure and try to come up with smart things to
                        say along the way! There are three episodes in this
                        playlist.
                    </figcaption>
                </figure>
            </div>
